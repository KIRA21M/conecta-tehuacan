...
export default function Empleos() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: '#F8FAFF', fontFamily: "'Segoe UI', sans-serif" }}>
      <style>{`
        @keyframes pulse {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.4; }
      ...
      {/* BÚSQUEDA */}
      <section style={{ backgroundColor: '#ffffff', padding: '40px 20px', borderBottom: '1px solid #e5e7eb' }}>
      ...
      {/* CONTENIDO */}
      <section style={{ padding: '40px 20px', flex: 1 }}>
        <div style={{ width: '90%', maxWidth: '1100px', margin: 'auto', display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px' }}>

          {/* FILTROS */}
          <div style={{ backgroundColor: '#ffffff', borderRadius: '12px', padding: '24px', border: '1px solid #e5e7eb', height: 'fit-content' }}>
