...
# Conecta Tehuacán - Proyecto de Accesibilidad y DOM Dinámico

Este proyecto es una plataforma diseñada con **Next.js** para conectar buscadores de empleo con empresas, priorizando la accesibilidad web (A11y) y la gestión eficiente de componentes dinámicos.

## ♿ Estándares de Accesibilidad Obligatorios

El desarrollo debe regirse por los siguientes pilares:
